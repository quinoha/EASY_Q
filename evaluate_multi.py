...
def evaluate_model():
    target_distance = 9
    hidden_dim = 128
    model_path = f"checkpoints/cascade_d{target_distance}_H{hidden_dim}_ema.pth"
    ...
    os.makedirs("plotting/output_V2", exist_ok=True)
    all_stats = stats_cascade + stats_pymatching
    draw_and_save_plot(all_stats, save_path=f"plotting/output_V2/cascade_evaluation_d{target_distance}_H{hidden_dim}_ema.png")
